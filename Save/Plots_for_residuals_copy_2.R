...
plot(actual_values, type = 'l', col = 'red', lwd = 2, ylab = "Returns", xlab = "Time", main = "Forecasted vs Actual Values")
...
plot(last_actual, type = 'l', col = 'red', lwd = 2, ylab = "Returns", xlab = "Steps Ahead", main = "Last 5-step Ahead Forecast vs Actual Values")
lines(last_forecast, col = 'blue', lwd = 2)
legend("topright", legend = c("Actual", "Forecasted"), col = c("red", "blue"), lty = 1, lwd = 2)

plot(last_sigma_forecast, type = 'l', col = 'green', lwd = 2, ylab = "Sigma", xlab = "Steps Ahead", main = "Last 5-step Ahead Sigma Forecasts")
...
ggplot(acf_df, aes(x = lag, y = acf)) +
  ...
  labs(title = "ACF of Absolute Residuals with 5 step forecast",
       x = "Lag",
       y = "ACF") +
  theme_minimal() +
...
plot(tracker, type = 'l')
abline(v = quantile(residuals_ordered, 0.90))
abline(v = quantile(residuals_ordered, 0.95))
abline(v = quantile(residuals_ordered, 0.99))
